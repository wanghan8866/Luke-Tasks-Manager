...
# Prepare to read from env variables 
env = Env()
env.read_env()
...
SECRET_KEY = 'django-insecure-m)ia@w6$yv5drvbednvwne2$9vd3g^$ygju$$um5i48x!b!%$_'
...
# For Better Visual of Admin Page
JAZZMIN_SETTINGS = {
    # title of the window (Will default to current_admin_site.site_title if absent or None)
    "site_title": "Luke Task Manager Admin",

    # Title on the login screen (19 chars max) (defaults to current_admin_site.site_header if absent or None)
    "site_header": "Luke Task Manager",
