...
urlpatterns = [
    ...
    # Users
    path("user/emails-all/", api_views.AllUserEmails.as_view()),
    ...
    path("user/task-create-email/", api_views.TaskCreateWithEmailAPIView.as_view()),
    path("user/task-update/<task_id>/", api_views.TaskUpdateAPIView.as_view()),
    path("user/task-update-email/<task_id>/", api_views.TaskUpdateWithEmailAPIView.as_view()),
    ...
    path("user/todo-lists-task/<task_id>/", api_views.TaskToDoListAPIView.as_view()),
    ...
    path("user/todo-all-completed/<task_id>/", api_views.TaskToDoCompletedAllCreateAPIView.as_view()),
    # path("user/todo-all-restart/<task_id>/", api_views.TaskToDoCompletedAllCreateAPIView.as_view()),
